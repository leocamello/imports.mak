...
XDC_INSTALL_DIR        ?= /opt/ti/xdctools_3_60_02_34_core
SYSCONFIG_TOOL         ?= /opt/ti/sysconfig_1.4.0/sysconfig_cli.sh

FREERTOS_INSTALL_DIR   ?= /opt/FreeRTOSv10.3.1

GCC_ARMCOMPILER        ?= /opt/gcc-arm-none-eabi-9-2019-q4-major
